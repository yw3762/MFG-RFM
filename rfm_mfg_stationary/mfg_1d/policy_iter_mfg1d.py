...
from utils.utils_1d import init_rfm
...
def solve_1d_stationary_mfg(M_p_hjb, J_n_hjb, M_p_fp, J_n_fp, Q_hjb, Q_fp, R=100, eps=0.3, n_iters=20, tau=1e-8):
    """
    ...
    :param R: radius of truncation for Hamiltonian
