...
from utils.utils_1d import plot_errors, plot_by_iter, hamiltonian_1d
...
def get_fd_residuals(prev_q, curr_m, curr_u, curr_q, eps):
    ...
    curr_div_mq = fd_derivative(m_vals * curr_q_vals, h)
    ...
    total_system_fd_residual = torch.abs(fp_system_fd_residual) + torch.abs(hjb_system_fd_residual)
